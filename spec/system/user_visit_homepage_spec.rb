...
describe 'Usuário visita tela inicial'do
  it 'e vê galpões' do
    #Arrange
    warehouses = []
    warehouses << Warehouse.new(id:1, name:'Aeroporto SP', code: 'GRU', cep: '15000-000', address: 'Avenida do Aeroporto, 1000', city: 'Guarulhos', area: '100000', description: 'Aeroporto interncional')
